             ...
             if params.desOnDecom
                 ...
                 if numel(decomposition) > 1  
                     ...
                     for j=1:numel(decomposition)
                         ...
                         % cheat extractFeatures by a KAZE parser
                     ...
                     % establish KAZE as detected points (for representation)
                     new_points  = ...
                     KAZEPoints(points.Location,'Scale',points.Scale,'Metric',...
                                points.Metric,'Orientation',points.Orientation);
                                %'SignOfLaplacian',points.SignOfLaplacian);
                            
                 else
                     sprintf('Problem: No decomposition is available, changing to standard KAZE')
                     
                     switch class(points)
                
                     case {'KAZEPoints', 'vision.internal.KAZEPoints_cg',}
                         % donothing
                     otherwise    % adapt detected points to KAZE descriptor
                         points  = ...
                                   KAZEPoints(points.Location,'Scale',points.Scale,'Metric',...
                                   points.Metric);%,'SignOfLaplacian',points.SignOfLaplacian
                     end
