...
%%define dataset path
%params.Directory    = fullfile('Datasets/ImagePanorama/');
params.Directory    = fullfile('Datasets/my_pan_1_images/');
params.resize       = 0.5;

%%Detector parameters
params.detector     =  'SURF'; %'LoG_ss', 'SURF', 'SIFT', ...
params.nscales      =        5;
params.noctaves     =        3;
...
params.descriptor   =  'SURF'; % 'SIFT', 'SURF', 'DSP-SIFT'...
