...
%%define dataset path
params.Directory    = fullfile('dataset/ds5'); % uncomment to verify repeated texture change
% Detector's with name _NL are non-linear scale space decompositions.
%%Detector parameters
params.detector     =  'KAZE'; % 'DoH','LoG_ss', 'SURF', 'SIFT','DoG_ss','K_ss','KAZE','LoG_ss_NL','DoG_ss_NL','K_ss_NL' ...
...
params.descriptor   =  'KAZE'; % 'SIFT', 'SURF', 'DSP-SIFT','KAZE'...
