...
//
	string dataset_path = "/home/avsa/Desktop/P1/AVSA2020datasets/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_name = "AVSA2020datasets"; // project exe name
	string results_path = project_root_path+"/"+project_name+"/results/Task4/Parameter1";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double tau = 23; // to set ... //Lab1.1.1-3
			double alpha=0.5; // to set ... //Lab1.1.2-3
			...
			for (;;) {
		        ...
		        //...
           		...
           		//Lab1.4
           		avsa_bgs.unimodal_Gaussian(img, it);
