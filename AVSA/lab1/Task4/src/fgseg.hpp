...
namespace fgseg {
	...
	public:
		...
		//method to perform unimodal Gaussian BackGroundSubtraction for Lab1.4
		void unimodal_Gaussian(cv::Mat Frame, int it);
	...
	private:
		...
		cv::Mat _mat_mean; //matrix with means for lab1.4
		cv::Mat _mat_variance; //matrix with variances for lab1.4
