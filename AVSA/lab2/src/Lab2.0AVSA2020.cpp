...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/avsa/Desktop/2020AVSALab3_datasets"; //SET THIS DIRECTORY according to your download
		string dataset_cat[1] = {"dataset"};
		...
		//string baseline_seq[1] = {"AVSS2007/AVSSS07_EASY.mkv"};
		//string baseline_seq[1] = {"VISOR/visor_Video01.avi"};
		//string baseline_seq[1] = {"VISOR/visor_Video00.avi"};
...
//		string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
		...
		string project_root_path = "/home/avsa/Desktop/AVSA2020results"; //SET THIS DIRECTORY according to your project
