...
#define GRID_SIZE 2 //1,2,3,4,5,6,7,8,9...
#define STEP 1
...
int main(int argc, char ** argv)
{
	...
	std::string output_path = "/home/avsa/eclipse-workspace/Lab4.4/outvideos/";									//location to save output videos
	//std::string dataset_path = "/home/avsa/eclipse-workspace/kush_lab4.2/src/datasets";
	// dataset paths
	std::string sequences[] = {"basketball",										//test data for lab4.1b
	};
	/*
	...
	char clr_channel= 'H'; // If feature = RGB, then choose b/w R or G or B else is Feature= HSV then choose from H or S
	int histSize = 12; // Number of bins can be modified here
	bool HOG_feature = true;    // for HOG feature set this to true and select feature = GR
